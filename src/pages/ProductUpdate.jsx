    ...
    <>
      <form className={productRegist.container} onSubmit={handleProductRegisterSubmit}>
        <div className={productRegist.inputContainer}>
          <span className={productRegist.label}>상품명</span>
          <input
            type="text"
            value={productName}
        ...
        <div className={productRegist.inputContainer}>
          <span className={productRegist.label}>상품 설명</span>
          <textarea
        ...
        <div className={productRegist.inputContainer}>
          <span className={productRegist.label}>상품 가격</span>
          <input
            type="number"
            value={productPrice}
        ...
        <div className={productRegist.inputContainer}>
          <span className={productRegist.label}>상품 수량</span>
          <input
            type="number"
        ...
        <div className={productRegist.buttonContainer}>
          <button className={productRegist.button} onClick={OnReset}>
            취소
          </button>
          <button className={productRegist.button} type="submit">
            저장
          </button>
        </div>
      </form>
